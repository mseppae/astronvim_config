return {
  ...
  -- We need to setup rubocop here. This is because we use solargraph for LSP and diagnostics.
  -- But solargraph is way too slow for formatting.
  -- lsp.config.solargraph is explicitly saying not to format.
